...
public class VConstVarDeclList extends ConstVarDeclList {

    private ConstVarDeclList ConstVarDeclList;
    private VarDeclList VarDeclList;

    public VConstVarDeclList (ConstVarDeclList ConstVarDeclList, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VConstVarDeclList(\n");
